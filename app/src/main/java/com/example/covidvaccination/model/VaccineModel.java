...
public class VaccineModel {
    ...
    public VaccineModel(String vaccineCenter, String vaccineCharges, String vaccineAge, String vaccinationTimings, String vaccineName, String vaccineCenterTime, String vaccinationCenterAddress, String vaccineAvailable) {
        this.vaccineCenter = vaccineCenter;
        this.vaccinationCharges = vaccineCharges;
        this.vaccinationAge = vaccineAge;
        this.vaccinationTimings = vaccinationTimings;
        this.vaccineName = vaccineName;
        this.vaccineCenterTime = vaccineCenterTime;
        this.vaccinationCenterAddress = vaccinationCenterAddress;
